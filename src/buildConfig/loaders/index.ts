...
export function getLoaderGeneratorByType(config:WPACK.OPTS,loaderType:string):WPACK_INTERNAL.Loader[]{
	if(!(loaderType in loadersByType)){return;}
	return loadersByType[loaderType].map(loader=>setLoader(config,loader));
}

export function getLoaderGeneratorByName(config:WPACK.OPTS,name:string):WPACK_INTERNAL.Loader[]{
	if(!(name in loaders)){return;}
	return [setLoader(config,loaders[name])]
}

export function getLoader(config:WPACK.OPTS,name:string){
...
export function setLoader(config:WPACK.OPTS,loaderGenerator:WPACK_INTERNAL.LoaderGenerator<any,any>):WPACK_INTERNAL.Loader{
...
export default function getLoadersArray(config:WPACK.OPTS):WPACK_INTERNAL.Loader[]{
	if(
