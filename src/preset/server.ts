 ...
 */
export default function serverConfig(env:WPACK.ENV, optionsFilename:string, isProd:boolean, returnWebpackConfig:boolean):WEBPACK.CONFIG;
export default function serverConfig(env:WPACK.ENV, optionsFilename:string, isProd:boolean):WPACK.CONFIG;
export default function serverConfig
	...
	{
		return returnWebpackConfig ? getConfig(env,optionsFilename,'server',isProd,true) : getConfig(env,optionsFilename,'server',isProd);
	}