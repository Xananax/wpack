...
import fromFile from './Opts_fromFile';
...
/**
 * 
 * Takes an object of WPACK.OPTIONS and turns it into a
 * WPACK.CONFIG, suitable to create a webpack configuration file
 * 
 * @param {WPACK.OPTIONS} [opts] an object of options
 * @param {string} [optionsFile] a file of options, can be json, ini, or yaml; overrides the `opts` parameter
 * @returns {WPACK.CONFIG}
 */
export default function Opts_to_WpackConf
	( opts?:WPACK.OPTIONS
	, optionsFile?:string
	):WPACK.CONFIG
	{
